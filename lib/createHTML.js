...
const create = (teamMates) => {
    ...
    htmlFile.push(teamMates.filter((employee) => employee.getRole() === "Manager")
    .map((manager) => createManager(manager))
    );
    htmlFile.push(teamMates.filter((employee) => employee.getRole() === "Engineer")
    .map((engineer) => createEngineer(engineer))
    );
    htmlFile.push(teamMates.filter((employee) => employee.getRole() === "Intern")
